        ...
        return (
            ...
            <View style={{ flex: 1}}>
                ...
                <ScrollView>
                    ...
                    <Image source={require('../assets/Login.jpeg')} style={{ width: "100%", height: 500, marginTop: '3%', alignSelf: 'center', resizeMode: 'cover', borderRadius:15}}></Image>
                    ...
                    <TouchableOpacity style={{ width: '80%', height: 40, backgroundColor: '#4169E1', justifyContent: 'center', alignItems: 'center', borderRadius: '10%', alignSelf: 'center', marginTop: '3%' }} onPress={() => { this.signIn() }}>
                    ...
                    <TouchableOpacity style={{ width: '90%', height: 40, justifyContent: 'center', alignItems: 'center', borderRadius: '10%', alignSelf: 'center'}} onPress={() => { this.signUp() }}>
