            ...
            <View style={{ flex: 1}}>
             {/* <ImageBackground source={require('../assets/1.png')} style={{ flex: 1}}> */}
                <KeyboardAwareScrollView>
                    ...
                    <Image source={require('../assets/NewsLogin.jpg')} style={{ width: "100%", height: 500, alignSelf: 'center', resizeMode: 'cover', borderRadius:10 }}></Image>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: '5%', alignSelf: 'center', width: '90%', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <TextInput style={{ width: '90%', height: 30, borderBottomWidth: '2px', borderBottomColor: '#0F52BA', border: 2, marginLeft: '5%', paddingLeft: 20 }} placeholder='Enter Email Id' onChangeText={(val) => { this.setState({ email: val }); }} />
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: '5%', alignSelf: 'center', width: '95%', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <TextInput style={{ width: '85%', height: 30, borderBottomWidth: 2, borderBottomColor: '#0F52BA', border: 2, marginLeft: '5%', paddingLeft: 20 }} secureTextEntry='true' placeholder='Password' onChangeText={(val) => { this.setState({ password: val }); }} />
